...
namespace ID_Replacement
{
    partial class MainFrame : Form
    {
        ...
        private void InitializeComponents()
        {
            ...
            {
                Dock = DockStyle.Fill,  // Make it fill the entire scroll panel
            ...
            appointmentGrid.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 12, FontStyle.Bold);
            appointmentGrid.AlternatingRowsDefaultCellStyle.BackColor = Color.LightGray;
            appointmentGrid.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            appointmentGrid.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            appointmentGrid.GridColor = Color.LightGray;
            appointmentGrid.ReadOnly = true;
            appointmentGrid.RowTemplate.Height = 30;
